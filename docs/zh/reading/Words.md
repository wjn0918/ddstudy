...
| decoupled   | 解耦             |                                                                                                                                                                                            |
| unresolved  | 未解析           |                                                                                                                                                                                            |
| protocol    | 协议             | Spark Connection introduced a decoupled client-server architecture that allows remote connectivity to Spark clusters using then DataFrame API and unresolved logical plan as then protocol |
| separation  | 分离             |                                                                                                                                                                                            |
| ecosystem   | 生态系统         |                                                                                                                                                                                            |
