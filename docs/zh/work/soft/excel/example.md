...
::: note
power query 中Excel.CurrentWorkbook() 获取到的表即为通过自定义名称设置的
:::

![自定义名称](./imgs/selfName.jpg)
![使用](./imgs/selfName01.png)
## 填充上一个数据
...
## 安装vb
链接：https://pan.baidu.com/s/1NXPjrzYXiakeHq5Qxc-28w 
提取码：1x6e
...
Function getpychar(char)
    ...
    ElseIf (tmp >= 52980 And tmp <= 53678) Then
